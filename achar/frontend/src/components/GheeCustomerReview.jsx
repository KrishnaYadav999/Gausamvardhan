/* ---------------------------------------------------
    GHEE REVIEW — SAME UI AS ACHAR REVIEW
----------------------------------------------------*/
...
const GheeCustomerReview = ({ image, onSubmitted }) => {
  const { id } = useParams();
  ...
  const handleAddReview = async () => {
    ...
    try {
      ...
      // ⭐ Correct Ghee API Route
      const { data } = await axios.post(
        `/api/ghee-products/${id}/review`,
        payload
      );
...
export default GheeCustomerReview;
